...
モーターなどの「重い」負荷を用いる場合には、ACアダプタを別に持っておくのがよいです。電圧は5V、12Vがあるとたいていの場合は事足ります。昔のHDDケース用やいろいろなデバイス用のACアダプタがそこらへんから出てくるのではないでしょうか？チェックしたうえで、そういったものを流用することもできます。ついついたまってくるので、定期的に見直し、廃棄は行うとよいでしょう。

電圧でいくつかのバリエーションを持っておくとよいですが、前述のDC-DCコンバーターと組み合わせて使うこともできます。また、出力可能な電流にも（実際に作るときには）注意する必要があります。例えば1Aしか出せないADアダプタに5Aを食う負荷を接続すると、うまく動かなかったり、起動しないといったこともあり得ます。最悪ADアダプタが燃えます。ご注意を。
