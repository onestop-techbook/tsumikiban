...
### 部品ストックが大変
ある程度の規模の作品を作ろうと思うと、様々な部品ストックをしておく必要が生じます。このストック部品を持っておくのも案外大変です。抵抗やコンデンサなどの部品は個別に入手するのは案外大変です。

秋葉原在住、あるいは通勤経路に秋葉原があるといった状況でもなければ、細かい部品を都度入手するのは案外大変です。送料もバカになりませんし、都度注文して届くまで待つ間にモチベーションは削られてしまいます。
...
また、ADC(Analog to Digital Converter:アナログ値をデジタル値に変換して取り込むモジュール)もよく使われますが、生値では12bitないしは16bitのバイナリ値が取れるだけであって、電圧値として取り込む場合には、適宜変換してやる必要があります。
