...
確認したコマンドはすべてATコマンドで、最終的にWi-Fiネットワークへ参加したり、SoftAPを立ち上げて普通のデバイス[^ipod_touch]をそこへ参加させることまでできました。[^ATコマンドの動作確認]
...
[^tuiito]:せかいい(2021)『せかいい on Twitter: "え、ちょっと待って完成したんだけど！？え！？！？" / Twitter』 https://twitter.com/Jewel_Flash/status/1462814517910405120 （2021年11月23日閲覧）
...
<!--[^deep-sleep-time-limit]: [tex:2\^32]-1=4294967295 ms [tex:/fallingdotseq]71.5 min-->
